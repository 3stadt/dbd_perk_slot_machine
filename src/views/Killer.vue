<template>
    <div>
        <div>
            <perkslot0 @reRollRequested="randomize" ref="perkslot0" type="Kill" :elementLength="elementLength"
                       :colorized="col"/>
            <perkslot1 @reRollRequested="randomize" ref="perkslot1" type="Kill" :elementLength="elementLength"
                       :colorized="col"/>
            <perkslot2 @reRollRequested="randomize" ref="perkslot2" type="Kill" :elementLength="elementLength"
                       :colorized="col"/>
            <perkslot3 @reRollRequested="randomize" ref="perkslot3" type="Kill" :elementLength="elementLength"
                       :colorized="col"/>
        </div>
